...
use shangtao\admin\model\Staffs;
use shangtao\admin\model\Menus;
use shangtao\admin\model\Index as M;
/**
 * 首页控制器
 */
class Index extends Base{
    ...
    public function getVersion(){
    	...
    	$content = file_get_contents('http://www.shangtao.net/index.php?m=Api&c=Download&a=getLastVersion&key='.$url);
    ...
    public function verifyLicense(){
    	...
    	$content = file_get_contents('http://www.shangtao.net/index.php?m=Api&c=License&a=verifyLicense&key='.$key);
    	$json = json_decode($content,true);
    	$rs = array('status'=>1);
