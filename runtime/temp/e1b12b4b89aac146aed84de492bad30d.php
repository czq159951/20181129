<?php /*a:2:{s:65:"/www/beidou/mart/zsbd_mart/shangtao/admin/view/articles/list.html";i:1536647730;s:56:"/www/beidou/mart/zsbd_mart/shangtao/admin/view/base.html";i:1536627213;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="wst-toolbar">
   <input id="catSel" type="text" readonly onclick="showMenu();" style='width:250px;' placeholder="请选择文章分类"/>
   ...
   <input type='text' id='key' placeholder='请输入文章标题'/> 
   ...
   <button class="btn btn-primary f-right btn-fixtop" onclick='javascript:toEdit(0)'><i class='fa fa-plus'></i>新增</button>
   <?php endif; ?>
