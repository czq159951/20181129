<?php /*a:6:{s:74:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shop_join_step2.html";i:1536627233;s:63:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/base.html";i:1536627231;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:75:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/self_shop_header.html";i:1536627232;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/header.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>入驻人联系方式 - 商家入驻 - <?php echo WSTConf('CONF.mallName'); ?><?php echo WSTConf('CONF.mallTitle'); ?></title>
    ...
    <div class='apply-box'>
      ...
      <table class='agreement-table' style='margin-top:10px;margin-bottom:10px;'>
        <tr>
          ...
          <td><input type='text' id='applyLinkMan' class='a-ipt' data-rule='联系人姓名:required;' value="<?php echo $apply['applyLinkMan']; ?>"/></td>
        </tr>
        <tr>
          <th>联系人手机<font color='red'>*</font>：</th>
          <td><input type='text' class='a-ipt' id='applyLinkTel' data-rule='联系人手机:required;mobile' value="<?php echo $apply['applyLinkTel']; ?>"/></td>
        </tr>
        <tr>
          <th>联系人电子邮箱<font color='red'>*</font>：</th>
          <td>
          <input type='text' name='applyLinkEmail' class='a-ipt' id='applyLinkEmail' data-rule='联系人电子邮箱:required;email' value="<?php echo $apply['applyLinkEmail']; ?>"/>
        ...
        <tr>
          ...
          <td>
            <label>
              <input type='radio' name='isInvestment' id='isInvestment1' class='a-ipt' value='1' onclick='javascript:WST.showHide(1,"#investmentStaffTr")' <?php if($apply['isInvestment']==1): ?>checked<?php endif; ?>/>有
            </label>
            <label>
              <input type='radio' name='isInvestment' id='isInvestment0' class='a-ipt' value='0' onclick='javascript:WST.showHide(0,"#investmentStaffTr")' <?php if($apply['isInvestment']==0): ?>checked<?php endif; ?>/>无
            </label>
            如果没有联系过商城招商人员请选择“无”。
          </td>
        </tr>
        <tr id='investmentStaffTr' <?php if($apply['isInvestment']==0): ?>style='display:none'<?php endif; ?>>
          <th>姓名<font color='red'>*</font>：</th>
          <td>
          <input type='text' name='investmentStaff' id='investmentStaff' class='a-ipt' data-rule="商城招商人员姓名:required(#isInvestment1:checked)" value="<?php echo $apply['investmentStaff']; ?>"/>
          </td>
        </tr>
      </table>
      </form>
     ...
     <div class='agreement-bottom'>
        <a href='<?php echo Url("home/shops/joinstep1"); ?>' class='btn-cancel'>上一步</a>
