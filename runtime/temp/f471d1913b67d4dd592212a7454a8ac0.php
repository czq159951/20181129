<?php /*a:4:{s:70:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/index.html";i:1536627232;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/base.html";i:1536627232;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
...
<div class='wst-shop-name'><a href='<?php echo Url("home/shops/home","shopId=".$data["shop"]["shopId"]); ?>'><?php echo $data['shop']['shopName']; ?></a></div>
<div class="wst-shop-info">
	<span class="wst-shop-img">
	  <a href="<?php echo url('home/shops/home',array('shopId'=>$data['shop']['shopId'])); ?>">
	  <img src="/<?php echo WSTImg($data['shop']['shopImg']); ?>" title="<?php echo $data['shop']['shopName']; ?>" alt="<?php echo $data['shop']['shopName']; ?>">
	  </a>
	</span>
	<div class="wst-shop-na">
		...
		<img src="/<?php echo $sv['accredImg']; ?>" title='<?php echo $sv['accredName']; ?>' alt='<?php echo $sv['accredName']; ?>'>
		<?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
	...
	<div class="wst-shop-eva">
		...
		<?php $__FOR_START_767982597__=0;$__FOR_END_767982597__=$data['shop']['scores']['goodsScore'];for($i=$__FOR_START_767982597__;$i < $__FOR_END_767982597__;$i+=1){ ?>
			<img src="/static/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_979957686__=1;$__FOR_END_979957686__=6-$data['shop']['scores']['goodsScore'];for($i=$__FOR_START_979957686__;$i < $__FOR_END_979957686__;$i+=1){ ?>
	...
	<div class="wst-shop-eva">
		<p>时效评分</p>
		<div class="wst-shop-evai">
		<?php $__FOR_START_1264448760__=0;$__FOR_END_1264448760__=$data['shop']['scores']['timeScore'];for($i=$__FOR_START_1264448760__;$i < $__FOR_END_1264448760__;$i+=1){ ?>
			<img src="/static/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_1222500552__=1;$__FOR_END_1222500552__=6-$data['shop']['scores']['timeScore'];for($i=$__FOR_START_1222500552__;$i < $__FOR_END_1222500552__;$i+=1){ ?>
			<img src="/static/plugins/raty/img/star-off.png">
		<?php } ?>
		</div>
	</div>
	<div class="wst-shop-eva">
		<p>服务评分</p>
		<div class="wst-shop-evai">
		<?php $__FOR_START_537309442__=0;$__FOR_END_537309442__=$data['shop']['scores']['serviceScore'];for($i=$__FOR_START_537309442__;$i < $__FOR_END_537309442__;$i+=1){ ?>
			<img src="/static/plugins/raty/img/star-on.png">
		<?php } $__FOR_START_922475263__=1;$__FOR_END_922475263__=6-$data['shop']['scores']['serviceScore'];for($i=$__FOR_START_922475263__;$i < $__FOR_END_922475263__;$i+=1){ ?>
			<img src="/static/plugins/raty/img/star-off.png">
		<?php } ?>
		</div>
	</div>
		...
		<ul class="main_mid_box">
				...
				<div class="mid_l_item">
					<div class="main_title">
						...
						<div class="wst-rfloat">
								<span class="complain_num"><?php echo $data['stat']['complainNum']; ?></span>
					...
					<div class="mid_main">
						<ul class="order_info">
							<li>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['waitReceiveCnt']; ?></p>
									<span class="c14_555">待收货</span>
								</div>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['waitDeliveryCnt']; ?></p>
							...
							<li>
								<div class="item_center">
									<div class="info_item">
										<p class="c32_e33"><?php echo $data['stat']['orderNeedpayCnt']; ?></p>
							...
							<li>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['cancel']; ?></p>
									<span class="c14_555">取消/拒收</span>
								</div>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['orderRefundCnt']; ?></p>
				...
				<div class="mid_l_item" style="margin-top:20px;">
					...
					<div class="mid_main">
						<ul class="order_info">
							<li>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['unSaleCnt']; ?></p>
									<span class="c14_555">仓库中</span>
								</div>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['stockWarnCnt']; ?></p>
							...
							<li>
								<div class="item_center item_sale">
									<div class="info_item">
										<p class="c32_e33"><?php echo $data['stat']['onSaleCnt']; ?></p>
							...
							<li>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['waitAuditCnt']; ?></p>
									<span class="c14_555">待审核</span>
								</div>
								<div class="info_item">
									<p class="c32_e33"><?php echo $data['stat']['illegalCnt']; ?></p>
				...
				<div class="index-right">
					<div class="index-right-item">
						...
						<ul class="right-list-tit right-list">
							...
							<li class="wst-textover"><a class="c14_ff90" target="_blank" href="<?php echo url('home/goods/detail',['goodsId'=>$glist['goodsId']]); ?>"><?php echo WSTMSubstr($glist['goodsName'],0,15); ?></a></li>
							<li class="c14_ff66"><?php echo !empty($glist['goodsNum']) ? $glist['goodsNum'] : 0; ?></li>
						</ul>
						<?php endforeach; endif; else: echo "" ;endif; ?>
			...
			<li class="mid_r">
				<div class="mid_r_rtop">
					...
					<div class="rtop_main">
						<p class="rtop_item">电话：<?php echo WSTConf('CONF.serviceTel'); ?></p>
						<p class="rtop_item">邮箱：<?php echo WSTConf('CONF.serviceEmail'); ?></p>
					</div>
				</div>
				<div class='mid_r_rbottom'>
					...
					<div class="rbottom_main">
						<ul class="shop_tips">
							<?php $wstTagArticle =  model("common/Tags")->listArticle("51",10,0); foreach($wstTagArticle as $key=>$vo){?>
							<li class="wst-textover"><a href="<?php echo url('home/news/view',['id'=>$vo['articleId']]); ?>" target="_blank"><?php echo $vo['articleTitle']; ?></a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
