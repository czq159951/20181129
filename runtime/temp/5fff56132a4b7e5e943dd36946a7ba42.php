<?php /*a:2:{s:35:"addons/groupon/view/admin/list.html";i:1536627263;s:58:"addons/groupon/view/../../../shangtao/admin/view/base.html";i:1536627213;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="msgTab">
	...
	<div class="layui-tab-item layui-show">
		...
		<input type="text" name="shopName1"  placeholder='店铺名称/店铺编号' id="shopName1" class='j-ipt'/>
		...
		<input type="text" name="goodsName1"  placeholder='商品名称/商品编号' id="goodsName1" class='j-ipt'/>
   ...
   <div class="layui-tab-item">
        <div class="wst-toolbar">
		<select id="areaId2" class='j-ipt j-areas hide' level="0" onchange="WST.ITAreas({id:'areaId2',val:this.value,className:'j-areas'});">
		  <option value="">-商家所在地-</option>
		  <?php if(is_array($areaList) || $areaList instanceof \think\Collection || $areaList instanceof \think\Paginator): $i = 0; $__LIST__ = $areaList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		  <option value="<?php echo $vo['areaId']; ?>"><?php echo $vo['areaName']; ?></option>
		  <?php endforeach; endif; else: echo "" ;endif; ?>
		</select>
		<input type="text" name="shopName2"  placeholder='店铺名称/店铺编号' id="shopName2" class='j-ipt'/>
		...
		<input type="text" name="goodsName2"  placeholder='商品名称/商品编号' id="goodsName2" class='j-ipt'/>
...
<script src="/addons/groupon/view/admin/list.js?v=<?php echo $v; ?>" type="text/javascript"></script>
