...
function goodsByPage(p){
	...
	params.page = p;
	$.post("<?php echo addon_url('distribut://distribut/queryDistributGoods'); ?>",params,function(data,textStatus){
