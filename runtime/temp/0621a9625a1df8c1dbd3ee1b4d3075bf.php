...
function moneyByPage(p){
	...
	params.page = p;
	$.post("<?php echo addon_url('distribut://distribut/queryUserMoneys'); ?>",params,function(data,textStatus){
