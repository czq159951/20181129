<?php /*a:7:{s:68:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/self_shop.html";i:1536734393;s:63:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/base.html";i:1536627231;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:75:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/self_shop_header.html";i:1536627232;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/header.html";i:1536627233;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/right_cart.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
...
<div class="s-banner">
	...
	<div class="s-cat">
		 <?php if(is_array($data['shopcats']) || $data['shopcats'] instanceof \think\Collection || $data['shopcats'] instanceof \think\Paginator): $k1 = 0;$__LIST__ = is_array($data['shopcats']) ? array_slice($data['shopcats'],0,6, true) : $data['shopcats']->slice(0,6, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat1): $mod = ($k1 % 2 );++$k1;?>
		  <div class="shop-cat1" cid="<?php echo $k1-1; ?>" id="ct1-<?php echo $k1-1; ?>">
		  	<div class="shop-cat1-title">
		  	<em class="em<?php echo $k1; ?>"></em>
		  	<h3>
	  		...
	  		<p class="shop-ct1-ct2">
	  			<?php if(is_array($cat1['children']) || $cat1['children'] instanceof \think\Collection || $cat1['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $cat1['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
	  			<a href="<?php echo url('home/shops/cat',['shopId'=>$data['shop']['shopId'],'ct1'=>$cat1['catId'],'ct2'=>$v1['catId']]); ?>"><?php echo $v1['catName']; ?></a> 
	  			<?php endforeach; endif; else: echo "" ;endif; ?>
	  		</p>
		 </div>

	      <ul class="shop-cat2 cid<?php echo $k1-1; ?>" cid="<?php echo $k1-1; ?>">
	      	<?php if(is_array($cat1['children']) || $cat1['children'] instanceof \think\Collection || $cat1['children'] instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($cat1['children']) ? array_slice($cat1['children'],0,20, true) : $cat1['children']->slice(0,20, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat2): $mod = ($i % 2 );++$i;?>
		...
		<div class="s-wst-slide" id="s-wst-slide" style="width:100%;float:right;height:500px;overflow:hidden;">
			...
			<ul class="s-wst-slide-items">
				<?php if(is_array($data['shop']['shopAds']) || $data['shop']['shopAds'] instanceof \think\Collection || $data['shop']['shopAds'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['shop']['shopAds'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<a href="<?php echo $vo['adUrl']; ?>" <?php if(($vo['isOpen'])): ?>target='_blank'<?php endif; ?>><li style="background: url(/<?php echo $vo['adImg']; ?>) no-repeat  scroll center center;background-size:cover" ></li></a>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
	...
	<div class="s-buy-new-best-hot">
		...
		<div class="s-rec-glistbox" id="fl_f_0_pl">
			<ul class="s-rec-goods-list">
			    <?php if(is_array($data['rec']) || $data['rec'] instanceof \think\Collection || $data['rec'] instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($data['rec']) ? array_slice($data['rec'],0,4, true) : $data['rec']->slice(0,4, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<li>
				    <a href='<?php echo Url("home/goods/detail","goodsId=".$vo["goodsId"]); ?>' target='_blank'>
					  <img class='goodsImg' data-original="/<?php echo WSTImg($vo['goodsImg']); ?>"  title="<?php echo $vo['goodsName']; ?>"/>
					</a>
					<div class="rec_ginfo">
						<p class="s-rec-goods-desc"><a href='<?php echo Url("home/goods/detail","goodsId=".$vo["goodsId"]); ?>' target='_blank'><?php echo $vo['goodsName']; ?></a></p>
		...
		<div class="s-rec-glistbox" id="fl_f_1_pl" style="display:none;">
			<ul class="s-rec-goods-list">
			    <?php if(is_array($data['hot']) || $data['hot'] instanceof \think\Collection || $data['hot'] instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($data['hot']) ? array_slice($data['hot'],0,4, true) : $data['hot']->slice(0,4, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot): $mod = ($i % 2 );++$i;?>
				<li>
				    <a href='<?php echo Url("home/goods/detail","goodsId=".$hot["goodsId"]); ?>' target='_blank'>
					  <img class='goodsImg' data-original="/<?php echo WSTImg($hot['goodsImg']); ?>"  title="<?php echo $hot['goodsName']; ?>"/>
					</a>
					<div class="rec_ginfo">
						<p class="s-rec-goods-desc"><a href='<?php echo Url("home/goods/detail","goodsId=".$hot["goodsId"]); ?>' target='_blank'><?php echo $hot['goodsName']; ?></a></p>
						<div class="s-rec-goods-bottom">
...
<div class="self_container_out">
	<div class="sf_headerbox">
		...
		<div class="sfhl f<?php echo $l; ?>_tit_bg">
		...
		<div class="sfhr">
			...
			<?php 
				...
				if($a>5)$a=5;
			 if(is_array($cat1['children']) || $cat1['children'] instanceof \think\Collection || $cat1['children'] instanceof \think\Paginator): $l2 = 0;$__LIST__ = is_array($cat1['children']) ? array_slice($cat1['children'],0,5, true) : $cat1['children']->slice(0,5, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat2): $mod = ($l2 % 2 );++$l2;?>
			<a href="<?php echo url('home/shops/home',['shopId'=>$data['shop']['shopId'],'ct1'=>$cat1['catId'],'ct2'=>$cat2['catId']]); ?>" class="c18_333"><?php echo $cat2['catName']; ?></a>
			<?php if(($l2<$a)): ?><span class="c18_333 separatory">/</span><?php endif; endforeach; endif; else: echo "" ;endif; ?>
			<span class="c18_333 separatory"> </span>
			<a href="<?php echo url('home/shops/home',['shopId'=>$data['shop']['shopId'],'ct1'=>$cat1['catId']]); ?>" class="c18_333">查看更多&nbsp;&nbsp;>></a>
		</div>
		<div class="wst-clear"></div>
	</div>
	
	<?php $wstTagAds =  model("common/Tags")->listAds("self-shop-f$l",1,86400); foreach($wstTagAds as $key=>$vo){?>
	<div class="sf_adsbox">
	...
	<div class="sf_glistbox f<?php echo $l; ?>_g_bg" style="background:#fff;">
		<ul class="sf_glist">
			<?php $wstTagShopFloorGoods =  model("common/Tags")->listShopFloorGoods($cat1['catId'],$data['shop']['shopId'],10,86400); foreach($wstTagShopFloorGoods as $key=>$sgf){?>
			<li>
				<a target="_blank" href="<?php echo Url('home/goods/detail','goodsId='.$sgf['goodsId']); ?>" title="<?php echo $sgf['goodsName']; ?>">
					<div class="sf_img">
						<img class='goodsImg' data-original="/<?php echo WSTImg($sgf['goodsImg']); ?>" alt="<?php echo $sgf['goodsName']; ?>" title="<?php echo $sgf['goodsName']; ?>"/>
					</div>
					<p class="sf_gname">
						<?php echo $sgf['goodsName']; ?>
					</p>
					<p class="sf_price">
						<span class="c11">￥</span><?php echo sprintf('%.1f',$sgf['shopPrice']); ?>
					</p>
				</a>
			</li>
			<?php } ?>
...
$(function(){
	...
	var url = "<?php echo url('mobile/shops/selfShop',array('shopId'=>$data['shop']['shopId']),true,true); ?>";
	qr.addData(url);
	qr.make();
