<?php /*a:6:{s:68:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shop_join.html";i:1536627231;s:63:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/base.html";i:1536627231;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:75:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/self_shop_header.html";i:1536627232;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/header.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
...
<div class='apply-banner'>
        <div class='wst-container'>
            <div class='apply-msg-box'>
                ...
                <?php else: ?>
                <a class='btn-submit' href='<?php echo Url("home/shops/joinStep".$applyStep); ?>'>申请入驻</a>
                <?php endif; ?>
        ...
        <div class="wst-slide" id="wst-slide">
            <ul class="wst-slide-items" style='min-width: 1200px;height: 420px;'>
                <?php $wstTagAds =  model("common/Tags")->listAds("ads-shop-apply",99,86400); foreach($wstTagAds as $key=>$vo){?>
                   <li style="background: url(/<?php echo $vo['adFile']; ?>) no-repeat  scroll center top;background-size:cover;height:350px;"></li>
                <?php } ?>
            </ul>
 ...
 <div class="apply-tips">
  <div class="wst-container">
     ...
     <h3>贴心提示</h3>
     </span><span class="content"><?php echo WSTConf('CONF.mallName'); ?>平台提供各类商家服务，协助您开通店铺、运营店铺、组织营销活动及分析运营数据，悉心为您解答各类疑问，引导您按相关规则展开运营；<br/>我们将竭尽全力，为您的店铺保驾护航。</span>
  </div>
 </div>
 <div class="wst-container">   
    ...
    <div class="apply-step">
        ...
        <span class="arrow"></span>
        <span class="step"><i class="d"></i>商家缴纳费用</span>
        <span class="arrow"></span>
    ...
    <div id='applyTab' class="wst-tab-box">
        ...
        <div class="wst-tab-content" style='width:99%;margin-bottom: 10px;min-height:300px;'>
            <div class="wst-tab-item" style="position: relative;"><?php echo htmlspecialchars_decode($artiles['105']['articleContent']); ?>
            </div>
            <div class="wst-tab-item" style="position: relative;">
            <?php echo htmlspecialchars_decode($artiles['106']['articleContent']); ?>
            </div>
            <div class="wst-tab-item" style="position: relative;">
            <?php echo htmlspecialchars_decode($artiles['107']['articleContent']); ?>
            </div>
            <div class="wst-tab-item" style="position: relative;">
            <?php echo htmlspecialchars_decode($artiles['108']['articleContent']); ?>
            </div>
        </div>
    </div>    
</div>
