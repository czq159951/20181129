<?php /*a:4:{s:75:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/shops/view.html";i:1536627231;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/base.html";i:1536627232;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
    ...
    <div class="wst-tab-content" style='width:99%;margin-bottom: 10px;'>
        <div class="wst-tab-item" style="position: relative;">
           <table id='vinfo_1' class='wst-form'> 
			  ...
			  <tr>
			     <th>店铺图标：</th>
			     <td>
			     <img id='v_shopImg' width='150' height='150' src='/<?php echo $object["shopImg"]; ?>'/>
			     </td>
			  </tr>
			  <tr>
			     <th>客服QQ：</th>
        ...
        <input type='hidden' id='shopImg' class='ipt_1' value='<?php echo $object["shopImg"]; ?>'/>
			  ...
			  <tr>
			     <th>客服QQ：</th>
			     <td>
			     	<input class="ipt_1" id="shopQQ" value="<?php echo $object['shopQQ']; ?>" type="text" style='width:60%'>
			     </td>
			  </tr>
			  <tr>
			     <th> </th>
