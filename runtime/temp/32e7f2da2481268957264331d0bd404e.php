<?php /*a:4:{s:85:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/shopconfigs/shop_cfg.html";i:1536627232;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/base.html";i:1536627232;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
    ...
    <form name="shopCfg"  id="shopCfg" autocomplete="off">
        ...
        <table class="wst-form">
           <tr>
             ...
             <td><input type='text' id='shopKeywords' name='shopKeywords' class="ipt"  value='<?php echo $object['shopKeywords']; ?>' data-rule='关键字:required;' style='width:350px;' maxLength='25' /></td>
           </tr>
           <tr>
           <th width='120'>店铺SEO描述：</th>
           <td colspan='3'>
               <textarea rows="2" style='width:350px;' class="ipt" id='shopDesc' name='shopDesc' ><?php echo $object['shopDesc']; ?></textarea>
           </td>
           </tr>
           <tr>
           <th width='120'>店铺热搜关键词：</th>
           <td><input type='text' id='shopHotWords' name='shopHotWords' class="ipt"  value='<?php echo $object['shopHotWords']; ?>' style='width:350px;' placeholder="店铺主页搜索栏下的引导搜索词" maxLength='100'/></td>
         </tr>
          ...
          <tr style="height:80px">
             ...
             <td>
              ...
              <div class="wst-lfloat shopbanner" <?php if(empty($object['shopStreetImg'])): ?>style='display:none'<?php endif; ?>>
                <img id="shopStreetImgPreview" class="lazyImg" height="100" style="max-width:500px;" src="/<?php echo $object['shopStreetImg']; ?>">
                <span class="del-banner" onclick="delShopStreetBg(this)">删除</span>
              </div>
                <input type="hidden" id="shopStreetImg" class="ipt" value="<?php echo $object['shopStreetImg']; ?>" />
              </div>
             </td>
           </tr>
           ...
           <tr style="height:80px">
             ...
             <td>
              ...
              <div style="margin-top:5px;">
              <div class="wst-lfloat shopbanner" <?php if(empty($object['shopBanner'])): ?>style='display:none'<?php endif; ?>>
                <img id="shopBannerPreview" class="lazyImg" height="100" style="max-width:500px;" src="/<?php echo $object['shopBanner']; ?>">
                <span class="del-banner" onclick="delbanner(this)">删除</span>
              </div>
                <input type="hidden" id="shopBanner" class="ipt" value="<?php echo $object['shopBanner']; ?>" />
              </div>
             </td>
           </tr>
            ...
            <tr style="height:80px">
             ...
             <td>
              ...
              <div style="margin-top:5px;">
              <div class="wst-lfloat shopbanner" <?php if(empty($object['shopMoveBanner'])): ?>style='display:none'<?php endif; ?>>
                <img id="shopMoveBannerPreview" class="lazyImg" height="100" style="max-width:500px;" src="/<?php echo $object['shopMoveBanner']; ?>">
                <span class="del-banner" onclick="delmovebanner(this)">删除</span>
              </div>
                <input type="hidden" id="shopMoveBanner" class="ipt" value="<?php echo $object['shopMoveBanner']; ?>" />
              </div>
             </td>
           </tr>
