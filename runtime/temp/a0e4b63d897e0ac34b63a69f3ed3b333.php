<?php /*a:4:{s:79:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/shoproles/edit.html";i:1536627232;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/base.html";i:1536627232;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>角色管理-卖家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-clear"></div>
   <div class="wst-shop-content">
    <?php $homeMenus = WSTHomeMenus(1); ?>
    <form name="shoprole"  id="shoprole" autocomplete="off">
        <table class="wst-form">
            <tr>
             <th width='120' align='right'>角色名称<font color='red'>*</font>：</th>
             <td>
              <input type='hidden' id='id' name='id' class="ipt"  value='<?php echo $object['id']; ?>' />
              <input type='text' id='roleName' name='roleName' class="ipt"  value='<?php echo $object['roleName']; ?>' data-rule='请输入角色名称:required;' style='width:350px;' maxLength='25' />
              ...
              <td>
                <div >
                 <?php if(is_array($homeMenus['menus']) || $homeMenus['menus'] instanceof \think\Collection || $homeMenus['menus'] instanceof \think\Paginator): $k1 = 0; $__LIST__ = $homeMenus['menus'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menus1): $mod = ($k1 % 2 );++$k1;?>
                 <dl <?php echo $k1==count($homeMenus['menus']) ? "style='border-bottom : 0'":""; ?>>
                   <dt class="dt1">
                    <label><input type="checkbox" id="<?php echo $menus1['menuId']; ?>" class="role_<?php echo $menus1['menuId']; ?>" value="<?php echo $menus1['menuId']; ?>" onclick="javascript:WST.checkChks(this,'.role_<?php echo $menus1['menuId']; ?>')"/> <?php echo $menus1["menuName"]; ?></label>
                   </dt>
                   <dd class="dd1">
                     <?php if(is_array($menus1['list']) || $menus1['list'] instanceof \think\Collection || $menus1['list'] instanceof \think\Paginator): $k2 = 0; $__LIST__ = $menus1['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menus2): $mod = ($k2 % 2 );++$k2;?>
                      <dl <?php echo $k2==count($menus1['list']) ? "style='border-bottom : 0'":""; ?>>
                       <dt class="dt2">
                        <label><input type="checkbox" id="<?php echo $menus2['menuId']; ?>" class="role_<?php echo $menus1['menuId']; ?>" value="<?php echo $menus2['menuId']; ?>" onclick="javascript:WST.checkChks(this,'.role_<?php echo $menus2['menuId']; ?>')" /> <?php echo $menus2["menuName"]; ?></label>
                       </dt>
                       <dd class="dd2">
                          <?php if(isset($menus2['list'])): if(is_array($menus2['list']) || $menus2['list'] instanceof \think\Collection || $menus2['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $menus2['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menus3): $mod = ($i % 2 );++$i;?>
                          <label>

                            <input type="checkbox" id="<?php echo $menus3['menuId']; ?>" name="menuIds" class="role_<?php echo $menus1['menuId']; ?> role_<?php echo $menus2['menuId']; ?> ipt" value="<?php echo $menus3['menuId']; ?>" <?php if(isset($object['menuUrls'])): ?><?php echo in_array(strtolower($menus3['menuUrl']),$object['menuUrls'])?"checked":""; endif; ?>/> <?php echo $menus3["menuName"]; ?>
                          </label>
                         <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                       </dd>
                     </dl>
            ...
            <tr>
             ...
             <td>
               <?php $_result=WSTDatas('SHOP_MESSAGE');if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
               <label>
               
                <input type="checkbox" name="privilegeMsgs" class="ipt" value="<?php echo $vo['dataVal']; ?>" <?php if($object['privilegeMsgs']): ?><?php echo in_array($vo['dataVal'],$object['privilegeMsgs'])?"checked":""; endif; ?>/> <?php echo $vo["dataName"]; ?>
            ...
            <tr>
              <td colspan='2' style='text-align:center;padding:20px;'>
                 ...
                 <a class='s-btn2' href='<?php echo url("home/shoproles/index"); ?>'>返&nbsp;回</a>
              </td>
            </tr>
        </table>
  </form>
...
<script type='text/javascript' src='__STYLE__/shops/shoproles/shoproles.js?v=<?php echo $v; ?>'></script>
