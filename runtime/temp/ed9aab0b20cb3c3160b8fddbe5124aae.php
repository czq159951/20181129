...
<div class="wst-container">
    ...
    <div class='pay-sbox'>
    	<div class="balance-box">
	        ...
	        <div class="pbox">
	        	<input type='hidden' id='key' value='<?php echo $paykey; ?>' class='j-ipt' autocomplete="off" />
	        	<?php if(($hasPayPwd==1)): ?>
