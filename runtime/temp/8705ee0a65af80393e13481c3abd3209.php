...
function moneyByPage(p){
	...
	params.page = p;
	$.post("<?php echo addon_url('distribut://distribut/queryDistributMoneys'); ?>",params,function(data,textStatus){
