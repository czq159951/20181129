<?php /*a:6:{s:39:"addons/coupon/view/home/index/list.html";i:1536627271;s:63:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/base.html";i:1536627231;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/header.html";i:1536627233;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/right_cart.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title><?php echo $catName; ?> - 领券中心 - <?php echo WSTConf('CONF.mallName'); ?><?php echo WSTConf('CONF.mallTitle'); ?></title>

<meta name="description" content="<?php echo $seoCouponDesc; ?>">
<meta name="Keywords" content="<?php echo $seoCouponKeywords; ?>">

<link href="__STYLE__/css/common.css?v=<?php echo $v; ?>" rel="stylesheet">

<link href="/addons/coupon/view/home/index/coupon.css?v=<?php echo $v; ?>" rel="stylesheet">
...
<input type="hidden" id="cat" class="sipt" value='<?php echo $couponCatId; ?>'/>
...
<div class="coupon-selector">
    ...
    <li><a href="<?php echo addon_url('coupon://coupons/index'); ?>" <?php if($couponCatId==0): ?>class='curr'<?php endif; ?>>全部商品分类</a></li>
    <?php if(is_array($catList) || $catList instanceof \think\Collection || $catList instanceof \think\Paginator): $i = 0; $__LIST__ = $catList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <li><a href="<?php echo addon_url('coupon://coupons/index','catId='.$vo['catId']); ?>" <?php if($couponCatId==$vo['catId']): ?>class='curr'<?php endif; ?>><?php echo $vo['catName']; ?></a></li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <div class="wst-clear"></div>
</div>
...
<div class="wst-container" id='coupon-container' sc="<?php echo date('Y-m-d H:i:s'); ?>">
	<div class="coupon-list">
	    <?php if(is_array($couponPage["data"]) || $couponPage["data"] instanceof \think\Collection || $couponPage["data"] instanceof \think\Paginator): $i = 0; $__LIST__ = $couponPage["data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <div class="coupon <?php if($vo['isReceive'] || $vo['isOut']): ?>coupon_out<?php endif; ?> " <?php if($key%3==0): ?>style='margin-left:0px;'<?php endif; if($key%3==2): ?>style='margin-right:0px;'<?php endif; ?>>
	      	<div class='coupon-left <?php if($vo['isOut']): ?>left-out<?php endif; ?>'>
	      		<div class='top'>
	      		<span class='shop-img'><a target='_blank' href='<?php echo Url("home/shops/home","shopId=".$vo["shopId"]); ?>'><img width="60" height="60" src='/<?php echo $vo["shopImg"]; ?>'></a></span>
	      		<span class='coupon-price'>￥<strong><?php echo $vo['couponValue']; ?></strong></span>
	      		</div>
	      		<div class='use-condition'><?php if($vo['useCondition']==1): ?>满<?php echo $vo['useMoney']; ?>减<?php echo $vo['couponValue']; endif; ?></div>
	      		<div><a target='_blank' href='<?php echo Url("home/shops/home","shopId=".$vo["shopId"]); ?>'><?php echo $vo['shopName']; ?></a></div>
	      		<div><?php if($vo['useObjects']==1): ?>指定部分商品可用<?php else: ?>全店可用<?php endif; ?></div>
	      		<div><?php echo $vo['startDate']; ?>  至 <?php echo $vo['endDate']; ?> </div>
				
				<?php if(($vo['isOut'])): ?>
	      			<div class='coupon_none'></div>
	      		<?php else: ?>
	      			<div id='receive_<?php echo $vo['couponId']; ?>' class='receive <?php if(!$vo['isReceive']): ?>hide<?php endif; ?>'></div>
	      		<?php endif; ?>

	      	</div>
	      	<div class='coupon-middle'></div>
	      	<div class='coupon-right <?php if($vo['isReceive'] || $vo['isOut']): ?>right-out<?php endif; ?>'>
	      		<a href='javascript:<?php if(!$vo['isOut']): ?>receiveCoupon(<?php echo $vo['couponId']; ?>)<?php else: ?>void(0)<?php endif; ?>'>
	      			立<br />
	      			即<br />
	      			领<br />
	      			取
...
<script type='text/javascript' src='/addons/coupon/view/home/index/index.js?v=<?php echo $v; ?>'></script>
<script type='text/javascript'>
laypage({
    cont: 'wst-pager',
    pages: <?php echo $couponPage["last_page"]; ?>, //总页数
    skip: true, //是否开启跳页
    skin: '#e23e3d',
    groups: 3, //连续显示分页数
...
var total = <?php echo $couponPage["last_page"]; ?>;
function page(t){
	var page = location.search.match(/page=(\d+)/);
	var curr = 1;
