<?php /*a:4:{s:47:"addons/distribut/view/home/users/user_list.html";i:1536627275;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/users/base.html";i:1536627217;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>我的推广用户-买家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-user-head"><span>我的推广用户</span></div>
  <div class='wst-user-tbar'>
             用户名称：<input type="text" name="userName" id="userName" class="s-query" />
     <button class="wst-sec-but u-btn" onclick="userByPage()">查询</button>
  </div>
  <div class='wst-user-content'>
    <table class='wst-order-list'>
       ...
       {{# for(var i = 0; i < d.length; i++){ }}
	      ...
	      <td>
	         {{d[i]['userSex']==1?"男":(d[i]['userSex']==2?"女":"保密")}}
	      </td>
		  <td>
	         {{d[i]['createTime']}}
	      </td>
...
function userByPage(p){
	...
	params.page = p;
	$.post("<?php echo addon_url('distribut://distribut/queryMineUsers'); ?>",params,function(data,textStatus){
