<?php /*a:4:{s:85:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/users/favorites/list_goods.html";i:1536627217;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/users/base.html";i:1536627217;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536649844;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>关注的商品 - 买家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
{{# for(var i = 0; i < d.length; i++){}}
	<div class="wst-fav-goods">
		<div class="wst-fav-goimg"><img class="goodsImg2" data-original="/{{ d[i].goodsImg }}" title="{{ d[i].goodsName }}"><span class="js-operate" onclick="javascript:cancelFavorite({{ d[i].favoriteId }},0)">取消收藏</div>
		...
		<p class="wst-fav-shop">
			...
			<img src="/{{ d[i].accreds[a].accredImg }}" title="{{ d[i].accreds[a].accredName }}">
			{{# } }}
		</p>
		</a>
	</div>
