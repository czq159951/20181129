<?php /*a:6:{s:40:"addons/groupon/view/home/index/list.html";i:1536627263;s:63:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/base.html";i:1536627231;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/header.html";i:1536627233;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/right_cart.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title><?php echo $catName; ?> - 团购商品 - <?php echo WSTConf('CONF.mallName'); ?><?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<link href="/addons/groupon/view/home/index/css/list.css?v=<?php echo $v; ?>" rel="stylesheet">
...
<div class="groupon-head">
   <div class="item" style="border-left:2px solid #df2003;padding-left: 8px;">
      ...
      <div class="wst-lfloat" style='line-height: 22px;'>团购活动 </div>
      <div class="wst-clear"></div>
</div>
	...
	<div class='goods-main'>
	   <div class="goods-list">
	      ...
	      <div class="goods" sv="<?php echo $vo['startTime']; ?>" ev="<?php echo $vo['endTime']; ?>" st="<?php echo $vo['status']; ?>">
	      	<div class="img"><a target='_blank' href="<?php echo addon_url('groupon://goods/detail','id='.$vo['grouponId']); ?>"><img title="<?php echo $vo['goodsName']; ?>" alt="<?php echo $vo['goodsName']; ?>" class='goodsImg2' data-original="/<?php echo $vo['goodsImg']; ?>"/></a></div>
	      	<div class='goods-txt'>
	      	    <div class="p-name">
	      	    <a target='_blank' href="<?php echo addon_url('groupon://goods/detail','id='.$vo['grouponId']); ?>"  title="<?php echo $vo['goodsName']; ?>"><?php echo $vo['goodsName']; ?></a>
	      	    </div>
	      		<div class="p-price">
	      		...
	      		<div class="p-hsale">
	      			<div class="sale-num"><span class="wst-fred"><?php echo $vo['zhekou']; ?>折</span></div>
		      		<a class="p-add-cart" style="display:none;" target='_blank' href="<?php echo addon_url('groupon://goods/detail','id='.$vo['grouponId']); ?>">马上参团</a>
	      		</div>
	      		<div class='wst-clear'></div>
	      		<div class='saleNum'>已售<?php echo $vo["orderNum"]; ?>件</div>
                <div class='countDown groupon-showTime'>截止：<?php echo $vo['endTime']; ?></div>
	      		<div class='wst-clear'></div>
	      	</div>
	      </div>
...
<script type='text/javascript' src='/addons/groupon/view/home/index/js/time.js?v=<?php echo $v; ?>'></script>
<script type='text/javascript' src='/addons/groupon/view/home/index/js/list.js?v=<?php echo $v; ?>'></script>
