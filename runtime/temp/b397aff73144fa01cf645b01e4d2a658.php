<?php /*a:4:{s:40:"addons/groupon/view/home/shops/edit.html";i:1536627263;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/base.html";i:1536627232;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536649844;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>团购设置 - 卖家中心</title>
...
<div class="wst-clear"></div>
   <div class="wst-shop-content">
      <form id='grouponform' name='grouponform' autocomplete="off">
        <input type='hidden' id='grouponId' class='ipt' value='<?php echo $object["grouponId"]; ?>'/>
        <table class="wst-form">
           ...
           <?php if($object['grouponStatus']==-1): ?>
           <tr class="wst-order-rate" >
               <th width='120'>不通过原因：</th>
             <td colspan='3' style='color:red'>
                 <?php echo $object['illegalRemarks']; ?>
             </td>
           </tr>
           <?php endif; ?>
           <tr>
             ...
             <td>
                ...
                <option value="<?php echo $object['goodsId']; ?>"><?php echo $object['goodsName']; ?></option>
              </select><br/>
             </td>
           </tr>
           <tr>
               <th width='120'>市场价格：</th>
	             <td colspan='3' id='marketPrice'>￥<?php echo $object["marketPrice"]; ?></td>
           </tr>
           <tr class="wst-order-rate" >
               <th width='120'>团购价格：</th>
	           <td colspan='3'>
	               <input type='text' id='grouponPrice' name='grouponPrice'class='ipt' maxLength='10' value='<?php echo $object["grouponPrice"]; ?>' data-rule='团购价格:required;price' data-rule-price="[/^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$/, '价格必须大于0']"/>
	           </td>
           </tr>
           <tr class="wst-order-rate" >
               <th width='120'>团购数量：</th>
	           <td colspan='3'>
	               <input type='text' id='grouponNum' name='grouponNum' class='ipt' maxLength='8' data-rule='团购数量:required;integer[+]' value='<?php echo $object["grouponNum"]; ?>'/>
	           </td>
           </tr>
           <tr class="wst-order-rate" >
               <th width='120'>团购时间：</th>
	           <td colspan='3'>
	               <input type='text' id='startTime' name='startTime' class='ipt laydate-icon' value='<?php echo $object["startTime"]; ?>' onclick="laydate({format: 'YYYY-MM-DD hh:mm:ss',istime:true})"  data-rule="开始日期: required;datetime;"/>
	               至
                   <input type='text' id='endTime' name='endTime' class='ipt laydate-icon' value='<?php echo $object["endTime"]; ?>' onclick="laydate({format: 'YYYY-MM-DD hh:mm:ss',istime:true})" data-rule="结束日期: required;datetime;match(gt, startTime, datetime)"/>
 	           </td>
           </tr>
           <tr class="wst-order-rate" >
               <th width='120'>团购说明：</th>
	           <td colspan='3'>
	               <textarea id='grouponDesc' class='ipt' style='width:70%;height:150px;'><?php echo $object["grouponDesc"]; ?></textarea>
	           </td>
           </tr>
           <tr>
...
<script src="/static/plugins/layer/laydate.js"></script>
<script type="text/javascript" src="/static/plugins/validator/jquery.validator.min.js?v=<?php echo $v; ?>"></script>
<script type="text/javascript" src="/addons/groupon/view/home/shops/shop.js?v=<?php echo $v; ?>"></script>
