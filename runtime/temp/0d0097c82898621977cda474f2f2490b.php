<?php /*a:4:{s:85:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/users/favorites/list_shops.html";i:1536627217;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/users/base.html";i:1536627217;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536649844;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>关注的店铺 - 买家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
{{# for(var i = 0; i < d.length; i++){ }}
	<div class="wst-favo-shop">
		<div class="wst-favo-shopl">
			<a href="javascript:getShop({{ d[i].shopId }})" class="wst-favo-shopimg"><img class="shopsImg2" data-original="/{{ d[i].shopImg }}" title="{{ d[i].shopName }}"/></a>
			  ...
			  <div class="als-viewport">
				...
				{{# for(var a = 0; a < d[i].goods.length; a++){ }}
			      <li class="als-item wst-favo-goods">
					<div class="wst-favo-goodimg"><a href="javascript:getGoods({{ d[i].goods[a].goodsId }})"><img class="goodsImg2" data-original="/{{ d[i].goods[a].goodsImg }}" title="{{ d[i].goods[a].goodsName }}"/></a></div>
