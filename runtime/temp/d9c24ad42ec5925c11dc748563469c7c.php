<?php /*a:4:{s:91:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/users/orders/list_order_appraise.html";i:1536627217;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/users/base.html";i:1536627217;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
  ...
  <div class='wst-user-content'>
    ...
    <div class="appraise-box">
      ...
      <div class="o-goods-info">
        <img src="/<?php echo $vo['goodsImg']; ?>" title="商品名称"  />
        <p class="o-goodsName" title="<?php echo $vo['goodsName']; ?>"><?php if($vo['goodsCode']=='gift'): ?>【赠品】<?php endif; ?><?php echo $vo['goodsName']; ?></p>
        <p class="o-goodsSpec" title="<?php echo $vo['goodsSpecNames']; ?>"><?php echo $vo['goodsSpecNames']; ?></p>
      </div>
    ...
    <div class="appraise-complate">
      ...
      <div class="appraise-area">
                <div class="appraise-item">
                  <div class="appraise-title">商品评分：</div>
                  <div class="appraise-content">
                    <?php $__FOR_START_1869427703__=0;$__FOR_END_1869427703__=$vo['appraise']['goodsScore'];for($i=$__FOR_START_1869427703__;$i < $__FOR_END_1869427703__;$i+=1){ ?>
                      <img src="/static/plugins/raty/img/star-on-big.png">
                    <?php } ?>
                  </div>
                </div>
                <div class="wst-clear"></div>
               ...
               <div class="appraise-item">
                    <div class="appraise-title"> 时效评分：</div>
                    <div class="appraise-content">
                       <?php $__FOR_START_1039452854__=0;$__FOR_END_1039452854__=$vo['appraise']['timeScore'];for($i=$__FOR_START_1039452854__;$i < $__FOR_END_1039452854__;$i+=1){ ?>
                        <img src="/static/plugins/raty/img/star-on-big.png">
                        <?php } ?>
                    </div>
               </div>
               ...
               <div class="appraise-item">
                  <div class="appraise-title">服务评分：</div>
                  <div class="appraise-content">
                      <?php $__FOR_START_1540572615__=0;$__FOR_END_1540572615__=$vo['appraise']['serviceScore'];for($i=$__FOR_START_1540572615__;$i < $__FOR_END_1540572615__;$i+=1){ ?>
                        <img src="/static/plugins/raty/img/star-on-big.png">
                      <?php } ?>
                  </div>
               </div>
               ...
               <div class="appraise-item">
                  ...
                  <div class="appraise-content">
                    ...
                    <?php if(is_array($vo['appraise']['images']) || $vo['appraise']['images'] instanceof \think\Collection || $vo['appraise']['images'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['appraise']['images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;if(!empty($img)): ?>
                      <img src="/<?php echo str_replace('.','_thumb.',$img); ?>" layer-src="/<?php echo $img; ?>" width="75" height="75" />
...
<script type="text/javascript" src="/static/plugins/raty/jquery.raty.min.js?v=<?php echo $v; ?>"></script>
...
var options = {
      ...
      width:200,
      targetKeep: true,
      starHalf:'/static/plugins/raty/img/star-half-big.png',
      starOff:'/static/plugins/raty/img/star-off-big.png',
      starOn:'/static/plugins/raty/img/star-on-big.png',
      cancelOff: '/static/plugins/raty/img/cancel-off-big.png',
        cancelOn: '/static/plugins/raty/img/cancel-on-big.png'
    }
