<?php /*a:4:{s:51:"addons/distribut/view/home/shops/distribut_cfg.html";i:1536627275;s:69:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/shops/base.html";i:1536627232;s:62:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/top.html";i:1536627233;s:65:"/www/beidou/mart/zsbd_mart/shangtao/home/view/default/footer.html";i:1536653987;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>分销设置-卖家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
   ...
   <div class="wst-shop-content">
        ...
        <table class="wst-form">
           <tr>
             ...
             <td>
             	<div class="radio-box">
			        <label><input type='radio' name='isDistribut' id="isDistribut-1" class='j-ipt wst-radio' value='1' <?php if($object['isDistribut'] == 1): ?>checked<?php endif; ?>/><label for="isDistribut-1" class="mt-1"></label>开启</label>
			        <label><input type='radio' name='isDistribut' id="isDistribut-0" class='j-ipt wst-radio' value='0' <?php if($object['isDistribut'] == 0): ?>checked<?php endif; ?>/><label for="isDistribut-0" class="mt-1"></label>关闭</label>
				</div>
             </td>
           </tr>
           <tr>
	           ...
	           <td colspan='3'>
	               <select id='distributType' class='j-ipt' onchange="setDistributType(this)">
		             <option value='1' <?php if($object['distributType'] == 1): ?>selected<?php endif; ?>>按商品设置提取佣金</option>
		             <option value='2' <?php if($object['distributType'] == 2): ?>selected<?php endif; ?>>按订单比例提取佣金</option>
		           </select>
		           <span style="color:red;">注：如果选择“按订单比例提取佣金”，则店铺内的所有商品将参与分销。</span>
	           </td>
           </tr>
           <tr class="wst-order-rate" <?php if($object['distributType'] == 1): ?>style="display:none;"<?php endif; ?>>
	           ...
	           <td colspan='3'>
	               <a href='#none' class='buy-btn' id='order-reduce' style='color:#ccc;' onclick='javascript:WST.changeIptNum(-1,"#orderNum","#order-reduce,#order-add")'>-</a>
					<input type='text' id='orderNum' class='buy-num' value="<?php echo $object['distributOrderRate']; ?>" data-min='1' data-max="99" autocomplete="off" onkeyup='WST.changeIptNum(0,"#orderNum","#order-reduce,#order-add")' onkeypress="return WST.isNumberKey(event);" maxlength="3"/>
...
function saveCfg(){
	...
	var url = "<?php echo addon_url('distribut://distribut/saveCfg'); ?>";
